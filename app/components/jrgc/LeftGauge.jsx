 ...
 * 左边仪表板
 */
class LeftGauge extends React.Component {
    ...
    render() {
        ...
        const baseOptionSet = {};
        let DATA_TOTAL= [{value: yczs, name: '异常指数'}];
        const dataOptionSet = {DATA_TOTAL};
        return (
            <div style={{display: 'inline-block', width: '30%'}}>
                <Gauge baseOptionSet={baseOptionSet} dataOptionSet={dataOptionSet} containerId="LeftGauge" width="20rem"
                       height="20rem"/>
            </div>
        );
    }
