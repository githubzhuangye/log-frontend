 ...
 * 左边仪表板
 */
class RightGauge extends React.Component {
    ...
    render() {
        ...
        const baseOptionSet = {};
        let DATA_TOTAL= [{value: 0, name: '商户指数'}];
        const dataOptionSet = {DATA_TOTAL};
        return (
            <div style={{display: 'inline-block', width: '30%'}}>
                <Gauge baseOptionSet={baseOptionSet} dataOptionSet={dataOptionSet} containerId="RightGauge" width="20rem"
                       height="20rem"/>
            </div>
        );
    }
