...
//下拉列表,三个下拉列表一个接口
export const ACTION_AUTO = 'yjsz/exception/ACTION_AUTO';
export const ACTION_AUTO_SUCCESS = 'yjsz/exception/ACTION_AUTO_SUCCESS';
export const ACTION_AUTO_ERROR = 'yjsz/exception/ACTION_AUTO_ERROR';


export const ACTION_AUTO_WARNING_WAYS='yjsz/exception/ACTION_AUTO_WARNING_WAYS'
export const ACTION_AUTO_WARNING_WAYS_SUCCESS='yjsz/exception/ACTION_AUTO_WARNING_WAYS_SUCCESS'
export const ACTION_AUTO_WARNING_WAYS_ERROR='yjsz/exception/ACTION_AUTO_WARNING_WAYS_ERROR'

export const ACTION_AUTO_RULE_TYPE='yjsz/exception/ACTION_AUTO_RULE_TYPE';
export const ACTION_AUTO_RULE_TYPE_SUCCESS='yjsz/exception/ACTION_AUTO_RULE_TYPE_SUCCESS';
export const ACTION_AUTO_RULE_TYPE_ERROR='yjsz/exception/ACTION_AUTO_RULE_TYPE_ERROR';

export const ACTION_AUTO_ELEMENTS='yjsz/exception/ACTION_AUTO_ELEMENTS'
export const ACTION_AUTO_ELEMENTS_SUCCESS='yjsz/exception/ACTION_AUTO_ELEMENTS_SUCCESS'
export const ACTION_AUTO_ELEMENTS_ERROR='yjsz/exception/ACTION_AUTO_ELEMENTS_ERROR'


export const ACTION_AUTO_PRODUCT_STATUS='yjsz/exception/ACTION_AUTO_PRODUCT_STATUS'
export const ACTION_AUTO_PRODUCT_STATUS_SUCCESS='yjsz/exception/ACTION_AUTO_PRODUCT_STATUS_SUCCESS'
export const ACTION_AUTO_PRODUCT_STATUS_ERROR='yjsz/exception/ACTION_AUTO_PRODUCT_STATUS_ERROR'

export const ACTION_AUTO_WARNING_LEVELS='yjsz/exception/ACTION_AUTO_WARNING_LEVELS'
export const ACTION_AUTO_WARNING_LEVELS_SUCCESS='yjsz/exception/ACTION_AUTO_WARNING_LEVELS_SUCCESS'
export const ACTION_AUTO_WARNING_LEVELS_ERROR='yjsz/exception/ACTION_AUTO_WARNING_LEVELS_ERROR'

export const ACTION_AUTO_CONDITION_TYPES='yjsz/exception/ACTION_AUTO_CONDITION_TYPES'
export const ACTION_AUTO_CONDITION_TYPES_SUCCESS='yjsz/exception/ACTION_AUTO_CONDITION_TYPES_SUCCESS'
export const ACTION_AUTO_CONDITION_TYPES_ERROR='yjsz/exception/ACTION_AUTO_CONDITION_TYPES_ERROR'


//下拉列表|异常类型
export const ACTION_AUTO_ONE = 'yjsz/exception/ACTION_AUTO_ONE';
export const ACTION_AUTO_ONE_SUCCESS = 'yjsz/exception/ACTION_AUTO_ONE_SUCCESS';
export const ACTION_AUTO_ONE_ERROR = 'yjsz/exception/ACTION_AUTO_ONE_ERROR';

//下拉列表|异常内容
export const ACTION_AUTO_TWO='yjsz/exception/ACTION_AUTO_TWO';
export const ACTION_AUTO_TWO_SUCCESS='yjsz/exception/ACTION_AUTO_TWO_SUCCESS';
export const ACTION_AUTO_TWO_ERROR='yjsz/exception/ACTION_AUTO_TWO_ERROR';
...
export const ACTION_ADD_ERROR = 'yjsz/exception/ACTION_ADD_ERROR';

export const ACTION_UPDATE = 'yjsz/exception/ACTION_UPDATE';
export const ACTION_UPDATE_SUCCESS = 'yjsz/exception/ACTION_UPDATE_SUCCESS';
export const ACTION_UPDATE_ERROR = 'yjsz/exception/ACTION_UPDATE_ERROR';

export const ACTION_DELETE = 'yjsz/exception/ACTION_DELETE';
export const ACTION_DELETE_SUCCESS = 'yjsz/exception/ACTION_DELETE_SUCCESS';
export const ACTION_DELETE_ERROR = 'yjsz/exception/ACTION_DELETE_ERROR';

export const ACTION_SELECTROW='yjsz/exception/ACTION_SELECTROW';

//弹窗
export const ACTION_DIALOG_OPEN = 'yjsz/exception/ACTION_DIALOG_OPEN';
export const ACTION_DIALOG_CLOSE = 'yjsz/exception/ACTION_DIALOG_CLOSE';

//右侧滑动条
export const ACTION_DRAWER_OPEN = 'yjsz/exception/ACTION_DRAWER_OPEN';
export const ACTION_DRAWER_CLOSE = 'yjsz/exception/ACTION_DRAWER_CLOSE'

//弹出连接窗口
export const ACTION_CONNECT_OPEN = 'yjsz/exception/ACTION_CONNECT_OPEN';
export const ACTION_CONNECT_CLOSE = 'yjsz/exception/ACTION_CONNECT_CLOSE'

//警示窗
export const ACTION_ALERT_OPEN = 'yjsz/exception/ACTION_ALERT_OPEN';
export const ACTION_ALERT_CLOSE = 'yjsz/exception/ACTION_ALERT_CLOSE';

//提示条
export const ACTION_SNACK_OPEN='yjsz/exception/ACTION_SNACK_OPEN'
export const ACTION_SNACK_CLOSE = 'yjsz/exception/ACTION_SNACK_CLOSE';

//详情
export const ACTION_DETAIL = 'yjsz/exception/ACTION_DETAIL';
