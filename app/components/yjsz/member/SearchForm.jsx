...
import {
    ...
    ACTION_AUTO_MEMBER,
    ACTION_AUTO_MEMBER_SUCCESS,
    ACTION_AUTO_MEMBER_ERROR
} from "./redux/Redux";
...
export default connect(
    (state, ownProps) => ({
        ...
        values: getFormValues('form-yjsz/member/select')(state),   //获取表单的所有values
    }),
    (dispatch, ownProps) => ({
        ...
        reqMember: (params) => dispatch(
            {
                url: URL_DICTIONARY_PREFIX +   URL_MEMBER_INFO,
                params: params,
                types: [ACTION_AUTO_MEMBER,ACTION_AUTO_MEMBER_SUCCESS,ACTION_AUTO_MEMBER_ERROR]
            }
        ),
