...
} from './redux/ScbbIdCardRedux'
import {
    REFRESH_SCBB_IDCARD_SEARCH_AUTOCOMPLETE,
    REFRESH_IDCARD_SEARCH_AUTOCOMPLETE_SUCCESS,
    REFRESH_IDCARD_SEARCH_AUTOCOMPLETE_ERROR
} from './redux/ScbbIdCardAutoCompleteRedux'
...
export default connect(
    (state, ownProps) => ({
        autoDataSource: state. ScbbIdCardAutoCompleteRedux
    }),
    (dispatch, ownProps) => ({
        ...
        fillAutoComplete: (params) => dispatch(
            {
                ...
                params: params,
                types: [REFRESH_SCBB_IDCARD_SEARCH_AUTOCOMPLETE, REFRESH_IDCARD_SEARCH_AUTOCOMPLETE_SUCCESS, REFRESH_IDCARD_SEARCH_AUTOCOMPLETE_ERROR]
            }
        ),
    })
)(IdCardSearchForm);
