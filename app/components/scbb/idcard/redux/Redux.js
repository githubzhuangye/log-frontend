...
export const Histogram_SERIES_NAMES = ['全部', '身份证返照片', '身份证不返照片'];//图例的名字,有3个视图,对应3个图例
...
//2.action静态字段
//1)表单部分
export const ACTION_AUTO = 'scbb/idcard/ACTION_AUTO';
export const ACTION_AUTO_SUCCESS = 'scbb/idcard/ACTION_AUTO_SUCCESS';
export const ACTION_AUTO_ERROR = 'scbb/idcard/ACTION_AUTO_ERROR';

//2)主体部分
export const ACTION_DATA = 'scbb/idcard/ACTION_DATA';//请求时长报表
export const ACTION_DATA_SUCCESS = 'scbb/idcard/ACTION_DATA_SUCCESS';
