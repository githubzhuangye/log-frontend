 ...
 * 身份证查询的表格
 */
class BankCardTable extends React.Component {
    ...
    render() {
        ...
        let topTitle = `${commitParams.beginDateStr} -- ${commitParams.endDateStr} ${commitParams.memberName} 银行卡查询商户返回时长报表`;
...
export default connect(
    (state, ownProps) => ({
        ALL_TABLE_DATA: getBankCardTableData(state.scbb_bankcard_redux.data, state.scbb_bankcard_redux.form.commitParams),
