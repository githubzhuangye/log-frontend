...
import styles from './css/YcbbBankCardSearchForm .css'
 ...
 */
class YcbbBankCardSearchForm extends React.Component {
...
export default connect(
    (state, ownProps) => ({
        exceptionTypes: state.ycbb_bankcard_redux.form.autoExceptionType,
        exceptionContents: state.ycbb_bankcard_redux.form.autoExceptionContent,
        loading: state.ycbb_bankcard_redux.loading
    }),
    (dispatch, ownProps) => ({
        reqData: (params) => dispatch(
            {
                url: URL_PREFIX + URL_YCBB_BANKCARD_PAGE,
                params: params,
        ...
        reqExceptionType: (params) => dispatch(
            {
                url: URL_PREFIX + URL_YCBB_BANKCARD_EXCEPTTYPES,
                params: params,
        ...
        reqExceptionContent: (params) => dispatch(
            {
                url: URL_PREFIX + URL_YCBB_BANKCARD_EXCEPTCONTENTS,
                params: params,
                types: [ACTION_AUTO_TWO,ACTION_AUTO_TWO_SUCCESS,ACTION_AUTO_TWO_ERROR]
            }
        ),
    })
)(YcbbBankCardSearchForm);
