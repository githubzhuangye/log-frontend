...
// 1)表单部分
//下拉列表|异常类型
export const ACTION_AUTO_ONE = 'ycbb/idcard/ACTION_AUTO_ONE';
export const ACTION_AUTO_ONE_SUCCESS = 'ycbb/idcard/ACTION_AUTO_ONE_SUCCESS';
export const ACTION_AUTO_ONE_ERROR = 'ycbb/idcard/ACTION_AUTO_ONE_ERROR';

//下拉列表|异常内容
export const ACTION_AUTO_TWO='ycbb/idcard/ACTION_AUTO_TWO';
export const ACTION_AUTO_TWO_SUCCESS='ycbb/idcard/ACTION_AUTO_TWO_SUCCESS';
export const ACTION_AUTO_TWO_ERROR='ycbb/idcard/ACTION_AUTO_TWO_ERROR';

// 2)主要表格|第一个表格
//获取分页数据
export const ACTION_PAGE = 'ycbb/idcard/ACTION_PAGE';
export const ACTION_PAGE_SUCCESS = 'ycbb/idcard/ACTION_PAGE_SUCCESS';
export const ACTION_PAGE_ERROR = 'ycbb/idcard/ACTION_PAGE_ERROR';

//显示详情
export const ACTION_DETAIL = 'ycbb/idcard/ACTION_DETAIL';
export const ACTION_DETAIL_SUCCESS = 'ycbb/idcard/ACTION_DETAIL_SUCCESS';
export const ACTION_DETAIL_ERROR = 'ycbb/idcard/ACTION_DETAIL_ERROR';

// 3)统计表格|第二个表格
//统计数据
export const ACTION_STATISCS='ycbb/idcard/ACTION_STATISCS';
